...
# docker build -t my_rails_bootstrap_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name my_rails_bootstrap_app my_rails_bootstrap_app
